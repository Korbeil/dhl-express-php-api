...
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID
{
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDContent|null
     */
    protected $content;
    /**
     * Here you can set invoice properties.
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDOutputImageProperties|null
     */
    protected $outputImageProperties;
    /**
     * Here you need to define all the parties needed to ship the package.
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDCustomerDetails|null
     */
     ...
     * Here you can define all the properties related to the content of the prospected shipment.
     */
    public function getContent(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDContent
    {
        return $this->content;
    }
     ...
     * Here you can define all the properties related to the content of the prospected shipment.
     */
    public function setContent(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDContent $content): self
    {
     ...
     * Here you can set invoice properties.
     */
    public function getOutputImageProperties(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDOutputImageProperties
    {
     ...
     * Here you can set invoice properties.
     */
    public function setOutputImageProperties(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDOutputImageProperties $outputImageProperties): self
    {
     ...
     * Here you need to define all the parties needed to ship the package.
     */
    public function getCustomerDetails(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDCustomerDetails
    {
     ...
     * Here you need to define all the parties needed to ship the package.
     */
    public function setCustomerDetails(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressUploadInvoiceDataRequestSIDCustomerDetails $customerDetails): self
    {
