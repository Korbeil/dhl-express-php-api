...
class SupermodelIoLogisticsExpressCreateShipmentRequest
{
    ...
    /**
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPickup|null
     */
    protected $pickup;
    /**
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties|null
     */
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails|null
     */
    protected $customerDetails;
    /**
     * Here you can define all the properties related to the content of the prospected shipment.
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent|null
     */
    protected $content;
    /**
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery|null
     */
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestEstimatedDeliveryDate|null
     */
     ...
     *
     * @var \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment|null
     */
    ...
    public function getPickup(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPickup
    {
        return $this->pickup;
    }

    public function setPickup(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPickup $pickup): self
    {
     ...
     * Here you can modify label, waybillDoc, invoice and receipt properties.
     */
    public function getOutputImageProperties(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties
    {
     ...
     * Here you can modify label, waybillDoc, invoice and receipt properties.
     */
    public function setOutputImageProperties(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties $outputImageProperties): self
    {
     ...
     * Here you can declare your customer references.
     *
     * @return list<\Korbeil\DHLExpress\Api\Model\Common\SupermodelIoLogisticsExpressReference>|null
     */
     ...
     * Here you can declare your customer references.
     *
     * @param list<\Korbeil\DHLExpress\Api\Model\Common\SupermodelIoLogisticsExpressReference>|null $customerReferences
     */
     ...
     * Here you need to define all the parties needed to ship the package.
     */
    public function getCustomerDetails(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails
    {
     ...
     * Here you need to define all the parties needed to ship the package.
     */
    public function setCustomerDetails(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails $customerDetails): self
    {
     ...
     * Here you can define all the properties related to the content of the prospected shipment.
     */
    public function getContent(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent
    {
        return $this->content;
    }
     ...
     * Here you can define all the properties related to the content of the prospected shipment.
     */
    public function setContent(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent $content): self
    {
     ...
     * This section is to support multiple base64 encoded string with the image of export documentation for Paperless Trade images. When an invalid base64 encoded string is provided, an error message will be returned.
     *
     * @return list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressDocumentImagesItem>|null
     */
     ...
     * This section is to support multiple base64 encoded string with the image of export documentation for Paperless Trade images. When an invalid base64 encoded string is provided, an error message will be returned.
     *
     * @param list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressDocumentImagesItem>|null $documentImages
     */
     ...
     * Here you can provide data in case you wish to use DHL Express On demand delivery service.
     */
    public function getOnDemandDelivery(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery
    {
     ...
     * Here you can provide data in case you wish to use DHL Express On demand delivery service.
     */
    public function setOnDemandDelivery(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery $onDemandDelivery): self
    {
     ...
     * This is to support sending email notification once the shipment is created. The email will contain the basic information on the shipper, recipient, waybill number, and shipment information.
     *
     * @return list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestShipmentNotificationItem>|null
     */
     ...
     * This is to support sending email notification once the shipment is created. The email will contain the basic information on the shipper, recipient, waybill number, and shipment information.
     *
     * @param list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestShipmentNotificationItem>|null $shipmentNotification
     */
     ...
     * Please provide any charges you have already paid for this shipment, like freight paid upfront. To allow using this section please contact your DHL Express representative.
     *
     * @return list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPrepaidChargesItem>|null
     */
     ...
     * Please provide any charges you have already paid for this shipment, like freight paid upfront. To allow using this section please contact your DHL Express representative.
     *
     * @param list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPrepaidChargesItem>|null $prepaidCharges
     */
     ...
     * Estimated delivery date option for QDDF or QDDC.
     */
    public function getEstimatedDeliveryDate(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestEstimatedDeliveryDate
    {
     ...
     * Estimated delivery date option for QDDF or QDDC.
     */
    public function setEstimatedDeliveryDate(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestEstimatedDeliveryDate $estimatedDeliveryDate): self
    {
     ...
     * Provides additional information in the response like service area details, routing code and pickup-related information.
     *
     * @return list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationItem>|null
     */
     ...
     * Provides additional information in the response like service area details, routing code and pickup-related information.
     *
     * @param list<\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationItem>|null $getAdditionalInformation
     */
     ...
     * Please provide the parent (mother) shipment details.
     */
    public function getParentShipment(): ?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment
    {
     ...
     * Please provide the parent (mother) shipment details.
     */
    public function setParentShipment(?\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment $parentShipment): self
    {
