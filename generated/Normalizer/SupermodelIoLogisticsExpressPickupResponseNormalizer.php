...
class SupermodelIoLogisticsExpressPickupResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressPickupResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressPickupResponse::class === $data::class;
    }
    ...
    {
        return [\Korbeil\DHLExpress\Api\Model\SupermodelIoLogisticsExpressPickupResponse::class => false];
    }
}
